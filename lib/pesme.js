...
function checkID() {
    return __awaiter(this, void 0, void 0, function* () {
        let response = yield fetch(common_1._URL + "/api/checkID/" + _eventID, {
            method: 'GET',
        });
...
function getEventSongs() {
    return __awaiter(this, void 0, void 0, function* () {
        let response = yield fetch(common_1._URL + "/api/event/songs/" + _eventID, {
            method: 'GET',
        });
...
function orderThisSong() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield fetch(common_1._URL + "/api/event/songs/" + _eventID + "/" + songID, {
            method: 'GET',
        });
...
function getListened() {
    return __awaiter(this, void 0, void 0, function* () {
        let response = yield fetch(common_1._URL + "/api/event/listened/" + _eventID, {
            method: 'GET',
        });
        let json = yield response.json();
        let listened = json;
...
function lastOrdered() {
    return __awaiter(this, void 0, void 0, function* () {
        let txtCont = document.getElementById("txtCont");
        let response = yield fetch(common_1._URL + "/api/event/last/" + _eventID, {
            method: 'GET',
        });
        let json = yield response.json();
        let lastOrderedSong = json;
